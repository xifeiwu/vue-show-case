<template>
  <div :class="{'nav-menu': true, collapse: collapseMenu}" :style="{width: (collapseMenu ? 56:$storeHelper.constants.sideMenuWidth)+'px'}">
    <div :class="{'img': true,  collapse: collapseMenu}">
      ...
      <img v-else style="padding-right: 18px;"@click="handleAsideMenuSelect('index', ['index'])" :src="`${ASSETS_PREFIX}assets/imgs/finup-cloud-2.png`">
    </div>
