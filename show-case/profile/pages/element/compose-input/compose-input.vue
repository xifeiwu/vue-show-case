<template>
  <div>
    ...
    <h1>级联选择</h1>
    <compose-input v-model="threeValues" :define="threeDefine" :data-source="threeDataSource" :noFormItem="true"></compose-input>
    <h1>动态组合</h1>
...
import ComposeInput from './compose-input.js';
const mapToOptions = (arr) => arr.map(it => ({ label: it, value: it }));
@Component({
